...
function Scorecard({ label, value, change, sentiment = "up_is_good" }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "hv-card", style: { padding: "16px", display: "flex", flexDirection: "column", gap: "0" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: "11px", fontWeight: 500, color: "var(--text-muted)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" } }, label), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "22px", fontWeight: 600, color: "var(--ink-950)", lineHeight: 1.1, marginTop: "4px", fontVariantNumeric: "tabular-nums" } }, value), showChange ? /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: "8px", marginTop: "8px" } }, /* @__PURE__ */ React.createElement("span", { style: {
    display: "inline-flex",
    alignItems: "center",
    gap: "3px",
    borderRadius: "999px",
...
function Checkbox({ label, checked, defaultChecked, onChange, disabled = false }) {
  hvEnsureCheckboxCss();
  return /* @__PURE__ */ React.createElement("label", { className: `hv-check${disabled ? " hv-check--disabled" : ""}` }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked, defaultChecked, onChange, disabled }), /* @__PURE__ */ React.createElement("span", { className: "hv-check__box" }, /* @__PURE__ */ React.createElement("svg", { width: "10", height: "10", viewBox: "0 0 10 10" }, /* @__PURE__ */ React.createElement("path", { d: "M1.5 5.5L4 8l4.5-6", fill: "none", stroke: "#fff", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round" }))), label ? /* @__PURE__ */ React.createElement("span", null, label) : null);
}
...
const HIVORY_ICON_PATHS = {
  ...
  settings: /* @__PURE__ */ React.createElement("g", null, /* @__PURE__ */ React.createElement("path", { d: "M2.5 4.5h11M2.5 8h11M2.5 11.5h11" }), /* @__PURE__ */ React.createElement("circle", { cx: "10", cy: "4.5", r: "1.6", fill: "var(--surface-card, #fff)" }), /* @__PURE__ */ React.createElement("circle", { cx: "5.5", cy: "8", r: "1.6", fill: "var(--surface-card, #fff)" }), /* @__PURE__ */ React.createElement("circle", { cx: "8.5", cy: "11.5", r: "1.6", fill: "var(--surface-card, #fff)" })),
