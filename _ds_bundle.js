...
.hv-menu--stretch{left:0;right:0}
...
function Menu({ trigger, items = [], onSelect, align = "left", side = "bottom", defaultOpen = false }) {
  hvEnsureMenuCss();
  const [open, setOpen] = React.useState(defaultOpen);
  const ref = React.useRef(null);
  React.useEffect(() => {
  ...
  return /* @__PURE__ */ React.createElement("span", { className: "hv-menu-wrap", ref }, /* @__PURE__ */ React.createElement("span", { onClick: () => setOpen(!open) }, trigger), open ? /* @__PURE__ */ React.createElement("div", { className: `hv-menu hv-menu--${side} hv-menu--${align}`, role: "menu" }, items.map(
...
try { (() => {
const Spinner = (...a) => __ds_scope.Spinner(...a);
const hvSignInCss = `
...
function InfoTip({ title, children, note, align = "start", size = 14 }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("button", { type: "button", className: "hv-infotip__btn", "aria-label": `How ${title} is measured` }, /* @__PURE__ */ React.createElement("svg", { width: size, height: size, viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("circle", { cx: "8", cy: "8", r: "5.75" }), /* @__PURE__ */ React.createElement("path", { d: "M8 7.4v3.4M8 5.1v.2" }))),
    /* @__PURE__ */ React.createElement("span", { className: "hv-infotip__pop", role: "tooltip" }, /* @__PURE__ */ React.createElement("b", { className: "hv-infotip__title" }, title), children, note ? /* @__PURE__ */ React.createElement("span", { className: "hv-infotip__note" }, note) : null)
  );
}
